...
import { addCountry, removeCountry } from '../store/features/country/countrySlice.ts'
    ...
    return (
        <Segment padded='very'>
            ...
            <div>
                <ul>
                    {countries.map((country) => (
                        <li key={country} onClick={()=>dispatch(removeCountry(country))} >
                            {country}
                        </li>
                    ))}
                </ul>
            ...
            <div>
                <ul>
                    {cities.map((city) => (
                        <li key={city} onClick={()=>dispatch(removeCity(city))} >
                            {city}
                        </li>
                    ))}
                </ul>
